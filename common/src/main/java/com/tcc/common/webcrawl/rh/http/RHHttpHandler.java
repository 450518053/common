package com.tcc.common.webcrawl.rh.http;
 ...
 *
 */
public class RHHttpHandler extends AbstractHttpHandler {
	
	/**
	 * 构建一个<code>RHHttpHandler.java</code>
	 * @param context
	 * @param headers
	 */
	public RHHttpHandler(HttpContext context, Header... headers) {
	 ...
	 */
	public RHHttpHandler(HttpContext context, List<Header> defaultHeaders) {
	...
	public BufferedImage downloadImg(String requestUrl, Header... headers) throws Exception {
		...
		headerList.add(new BasicHeader("Accept", "image/png,image/*;q=0.8,*/*;q=0.5"));
